...
if __name__ =="__main__":
	...
	Regions = nump.loadtxt('../SRTR/SRTR_Input_Geography.txt')
	...
	SharingPartners = nump.loadtxt("../SRTR/SRTR_Input_SPartners.txt")
	...
	#Output Results
	nump.savetxt(directory + f"{INPUT_DIRECTORY}_Output_deaths.txt", Sim.record_deaths, fmt='%1.4e', delimiter='\t', newline='\n')
	record_deaths.to_csv(directory + f"{INPUT_DIRECTORY}_Output_deaths.csv", sep=',', encoding='utf-8', index = False)

	nump.savetxt(directory + "Output_mr_disparity_mean.txt", Sim.record_mr_disparity_mean, fmt='%1.4e', delimiter='\t', newline='\n')
	record_mr_disparity_mean.to_csv(directory + f"{INPUT_DIRECTORY}_Output_mr_disparity_mean.csv", sep=',', encoding='utf-8', index = False)

	nump.savetxt(directory + "Output_mr_disparity_std.txt", Sim.record_mr_disparity_std, fmt='%1.4e', delimiter='\t', newline='\n')
	record_mr_disparity_std.to_csv(directory + f"{INPUT_DIRECTORY}_Output_mr_disparity_std.csv", sep=',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "Output_meld_disparity_mean.txt", Sim.record_meld_disparity_mean, fmt='%1.4e', delimiter='\t', newline='\n')
	record_meld_disparity_mean.to_csv(directory + f"{INPUT_DIRECTORY}_Output_meld_disparity_mean.csv", sep=',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "Output_meld_disparity_std.txt", Sim.record_meld_disparity_std, fmt='%1.4e', delimiter='\t', newline='\n')
	record_meld_disparity_std.to_csv(directory + f"{directory}_Output_meld_disparity_std.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "Output_meld_median_mean.txt", Sim.record_medMELDmean, fmt='%1.4e', delimiter='\t', newline='\n')
	record_medMELDmean.to_csv(directory + f"{INPUT_DIRECTORY}_Output_meld_median_mean.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "Output_meld_median_std.txt", Sim.record_medMELDstd, fmt='%1.4e', delimiter='\t', newline='\n')
	record_medMELDstd.to_csv(directory + f"{INPUT_DIRECTORY}_Output_meld_median_std.csv", sep =',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_ydeaths.txt", Sim.record_ydeaths, fmt='%1.4e', delimiter='\t', newline='\n')
	record_ydeaths.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_ydeaths.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_ytransplants.txt", Sim.record_ytransplants, fmt='%1.4e', delimiter='\t', newline='\n')
	record_ytransplants.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_ytransplants.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_yarrivals.txt", Sim.record_yarrivals, fmt='%1.4e', delimiter='\t', newline='\n')
	record_yarrivals.to_csv(directory + f"{INPUT_DIRECTORY}RawOutput_yarrivals.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_ycandidates.txt", Sim.record_ycandidates, fmt='%1.4e', delimiter='\t', newline='\n')
	record_ycandidates.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_ycandidates.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_yremoved.txt", Sim.record_yremoved, fmt='%1.4e', delimiter='\t', newline='\n')
	record_yremoved.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_yremoved.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_ywait.txt", Sim.record_ywait, fmt='%1.4e', delimiter='\t', newline='\n')
	record_ywait.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_ywait.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_yMELD.txt", Sim.record_yMELD, fmt='%1.4e', delimiter='\t', newline='\n')
	record_yMELD.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_yMELD.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_DSAs.txt", Sim.record_txDSA, fmt='%1.4e', delimiter='\t', newline='\n')
	record_txDSA.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_DSAs.csv", sep = ',', encoding = 'utf-8')

	nump.savetxt(directory + "RawOutput_DSAs2.txt", Sim.record_txDSAoutput, fmt='%1.4e', delimiter='\t', newline='\n')
	record_txDSAoutput.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_DSAs2.csv", sep = ',', encoding = 'utf-8')

	nump.savetxt(directory + "RawOutput_removals.txt", Sim.record_removals, fmt='%1.4e', delimiter='\t', newline='\n')
	record_removals.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_removals.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_IDdeaths.txt", Sim.record_deathsID, fmt='%1.4e', delimiter='\t', newline='\n')
	record_deathsID.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_IDdeaths.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_TxID.txt", Sim.record_txID, fmt='%1.4e', delimiter='\t', newline='\n')
	record_txID.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_TxID.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_DoID.txt", Sim.record_doID, fmt='%1.4e', delimiter='\t', newline='\n')
	record_doID.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_DoID.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_yrelists.txt", Sim.record_yrelists, fmt='%1.4e', delimiter='\t', newline='\n')
	yrelists.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_yrelists.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_yregrafts.txt", Sim.record_yregrafts, fmt='%1.4e', delimiter='\t', newline='\n')
	yregrafts.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_yregrafts.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_TxIDregraft.txt", Sim.record_txIDregraft, fmt='%1.4e', delimiter='\t', newline='\n')
	record_txIDregraft.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_TxIDregraft.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_DoIDregraft.txt", Sim.record_doIDregraft, fmt='%1.4e', delimiter='\t', newline='\n')
	record_doIDregraft.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_DoIDregraft.csv", sep = ',', encoding = 'utf-8', index = False)

	nump.savetxt(directory + "RawOutput_Relistid.txt", Sim.record_relists, fmt='%1.4e', delimiter='\t', newline='\n')
	record_relists.to_csv(directory + f"{INPUT_DIRECTORY}_RawOutput_Relistid.csv", sep = ',', encoding = 'utf-8', index = False)
